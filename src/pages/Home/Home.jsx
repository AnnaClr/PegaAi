...
export default function Home() {
  ...
  const handleCategoryClick = (categoryId) => {
    navigate(`/explorer?categoria=${categoryId}`);
  };
            ...
            <div className={styles.heroGrid}>
              <div className={styles.heroContent}>
                <h1 className={styles.heroTitle}>
                  <span className={styles.highlight}>Alugue</span> o que você
                  precisa,
                  <br />
                  <span className={styles.highlight}>compartilhe</span> o que
                  você tem
                </h1>
                <p className={styles.heroDescription}>
                  Junte-se à maior comunidade de compartilhamento de objetos do
                  Brasil. Economize, ganhe dinheiro e ajude o planeta.
                </p>
                ...
                <button
                  className={styles.heroAnnounceBtn}
              ...
              <div className={styles.heroImage}>
                ...
                />
                <div
                  className={`${styles.heroCard} ${styles.floatingCard} ${styles.card1}`}
                >
                ...
                <div
                  className={`${styles.heroCard} ${styles.floatingCard} ${styles.card2}`}
                >
